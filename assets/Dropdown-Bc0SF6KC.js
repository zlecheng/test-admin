...
`,[K("splitor",`
 ...
 `),ne("checked",{color:"var(--n-button-text-color-hover)"})]),C("focus",[A("&:not(:active)",[K("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),C("checked",`
 ...
 `)])]);function io(e,n,r){var i;const t=[];let o=!1;for(let a=0;a<e.length;++a){const l=e[a],d=(i=l.type)===null||i===void 0?void 0:i.name;d==="RadioButton"&&(o=!0);const v=l.props;if(d!=="RadioButton"){t.push(l);continue}if(a===0)t.push(l);else{const f=t[t.length-1].props,R=n===f.value,g=f.disabled,P=n===v.value,N=v.disabled,D=(R?2:0)+(g?0:1),k=(P?2:0)+(N?0:1),$={[`${r}-radio-group__splitor--disabled`]:g,[`${r}-radio-group__splitor--checked`]:R},b={[`${r}-radio-group__splitor--disabled`]:N,[`${r}-radio-group__splitor--checked`]:P},_=D<k?b:$;t.push(s("div",{class:[`${r}-radio-group__splitor`,_]}),l)}}return{children:t,isButtonGroup:o}}const ao=Object.assign(Object.assign({},Y.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),So=M({name:"RadioGroup",props:ao,setup(e){const n=O(null),{mergedSizeRef:r,mergedDisabledRef:i,nTriggerFormChange:t,nTriggerFormInput:o,nTriggerFormBlur:a,nTriggerFormFocus:l}=be(e),{mergedClsPrefixRef:d,inlineThemeDisabled:v,mergedRtlRef:f}=ie(e),R=Y("Radio","-radio-group",ro,Fe,e,d),g=O(e.defaultValue),P=T(e,"value"),N=ue(P,g);function D(I){const{onUpdateValue:B,"onUpdate:value":U}=e;B&&W(B,I),U&&W(U,I),g.value=I,t(),o()}function k(I){const{value:B}=n;B&&(B.contains(I.relatedTarget)||l())}function $(I){const{value:B}=n;B&&(B.contains(I.relatedTarget)||a())}X(ye,{mergedClsPrefixRef:d,nameRef:T(e,"name"),valueRef:N,disabledRef:i,mergedSizeRef:r,doUpdateValue:D});const b=Oe("Radio",f,d),_=x(()=>{const{value:I}=r,{common:{cubicBezierEaseInOut:B},self:{buttonBorderColor:U,buttonBorderColorActive:J,buttonBorderRadius:H,buttonBoxShadow:G,buttonBoxShadowFocus:E,buttonBoxShadowHover:u,buttonColor:m,buttonColorActive:h,buttonTextColor:p,buttonTextColorActive:F,buttonTextColorHover:c,opacityDisabled:w,[L("buttonHeight",I)]:j,[L("fontSize",I)]:V}}=R.value;return{"--n-font-size":V,"--n-bezier":B,"--n-button-border-color":U,"--n-button-border-color-active":J,"--n-button-border-radius":H,"--n-button-box-shadow":G,"--n-button-box-shadow-focus":E,"--n-button-box-shadow-hover":u,"--n-button-color":m,"--n-button-color-active":h,"--n-button-text-color":p,"--n-button-text-color-hover":c,"--n-button-text-color-active":F,"--n-height":j,"--n-opacity-disabled":w}}),S=v?ce("radio-group",x(()=>r.value[0]),_,e):void 0;return{selfElRef:n,rtlEnabled:b,mergedClsPrefix:d,mergedValue:N,handleFocusout:$,handleFocusin:k,cssVars:v?void 0:_,themeClass:S==null?void 0:S.themeClass,onRender:S==null?void 0:S.onRender}},render(){var e;const{mergedValue:n,mergedClsPrefix:r,handleFocusin:i,handleFocusout:t}=this,{children:o,isButtonGroup:a}=io(De(Te(this)),n,r);return(e=this.onRender)===null||e===void 0||e.call(this),s("div",{onFocusin:i,onFocusout:t,ref:"selfElRef",class:[`${r}-radio-group`,this.rtlEnabled&&`${r}-radio-group--rtl`,this.themeClass,a&&`${r}-radio-group--button-group`],style:this.cssVars},o)}}),xe=M({name:"DropdownDivider",props:{clsPrefix:{type:String,required:!0}},render(){return s("div",{class:`${this.clsPrefix}-dropdown-divider`})}}),lo=z("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
