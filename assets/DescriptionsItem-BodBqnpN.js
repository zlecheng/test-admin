import{a as p,c as e,av as F,b as C,d as B,c3 as G,c4 as H,e as E,u as K,f as L,cl as N,h as M,ad as T,i as W,ax as q,ay as J,j as n,bO as Q,bG as U}from"./index-DNQY-kEr.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
