import{a as p,c as e,av as V,b as C,d as B,c2 as G,c3 as H,e as E,u as N,f as L,ck as K,h as M,ad as T,i as W,ax as q,ay as J,j as n,bN as Q,bF as U}from"./index-BofSZpyf.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
